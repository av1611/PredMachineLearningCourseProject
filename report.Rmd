...
At first look on the data, it is obvious that a significant amount of columns are blank or not available. To simplify our model, we remove any column possessing either of these two traits. Afterwards, we should notice that the first eight columns are measurements not pertaining 
...
the class. In the Netflix contest, the top performers used an ensemble of 
